...
public class MstDestination {
	...
	//MstUserを受け取りデータをセット 
	public MstDestination(DestinationForm dstForm) {
		userId = dstForm.getUserId();
		familyName = dstForm.getFamilyName();
		firstName = dstForm.getFirstName();
		telNumber = dstForm.getTelNumber();
		address = dstForm.getAddress();
	}
